...
//                    date = mUserToDoItem.getToDoDate();
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(getContext(), AddToDoFragment.this, year, month, day);
...
//                    date = mUserToDoItem.getToDoDate();
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(getContext(), AddToDoFragment.this, hour, minute, DateFormat.is24HourFormat(getContext()));
